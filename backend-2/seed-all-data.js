...
async function main() {
  ...
  try {
    ...
    // 6. Generate 100 Activity Logs spanning the last 1 year
    console.log('Generating 100 historical Activity Logs for analysis...');
    const activityLogsToCreate = 100;
